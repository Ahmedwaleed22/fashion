                    ...
                    <div class="d-inline-block d-md-block mb-4">
                        <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}">
                            ...
                            <div class="form-group mb-0">
                                <input type="email" class="form-control" placeholder="{{ translate('Enter E-Mail') }}" name="email" required>
                            </div>
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                           <span class="d-block opacity-30">{{translate('Mobile Number')}}:</span>
                           <span class="d-block opacity-70">{{ get_setting('contact_phone') }}</span>
                        </li>
                        <li class="mb-2">
                           <span class="d-block opacity-30">{{translate('E-Mail')}}:</span>
